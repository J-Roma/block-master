...
const DownMovies = () => {
    ...
    useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=71168d3dc8fba2791d849d19ba33aeb5&sort_by=popularity.asc&page=${pagina}&language=es`)
            .then(async (datos) => {
                await dispatch(loadLowMovies([...list, ...datos.data.results]))
                setIsLoading(false)
            })
            .catch((e) => {
                console.log(e);
